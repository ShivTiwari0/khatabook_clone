...
import 'package:eassy_rokkad/utils/utils.dart';
...
class _AddPartyState extends State<AddParty> {
  ...
  FocusNode fgst = FocusNode();
  FocusNode fflat = FocusNode();
  FocusNode farea = FocusNode();
  FocusNode fpincode = FocusNode();
  FocusNode fcity = FocusNode();
  FocusNode fstate = FocusNode();
  FocusNode fdt = FocusNode();
                    ...
                    children: [
                      TextFormField(
                        ...
                        onFieldSubmitted: (value) {
                          Utils.fieldFocusChange(context, fname, fmobile);
                        },
                      ),
                      SizedBox(
                        height: 10,
